...
export const PhotoInput: React.FC<PhotoInputProps> = ({ onImageSelect, t }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full h-full p-6 pt-20 animate-fade-in overflow-hidden">
      ...
      <div className="absolute bottom-4 left-0 right-0 z-20 text-center space-y-1 p-4 pointer-events-auto">
        <p className="text-[10px] sm:text-xs text-slate-400/60 max-w-xs mx-auto">
           {t.disclaimer}
        </p>
